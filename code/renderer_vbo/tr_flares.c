...
void RB_RenderFlare( flare_t *f ) {
	...
	static glIndex_t indexes[6] = { 0, 1, 2, 0, 2, 3 };
 ...
 */
	...
	tess.vertexPtr[1].tc2[0] = 0.0f;
	tess.vertexPtr[1].tc2[1] = 1.0f;
	...
	tess.vertexPtr[3].tc2[0] = 1.0f;
	tess.vertexPtr[3].tc2[1] = 0.0f;
	...
	Com_Memcpy( tess.indexPtr, indexes, 6 * sizeof( glIndex_t ) );
